    ...
    <>
      ...
      <div className="bg-white text-black p-6 mt-10 mx-4 md:mx-20 mb-10 border-2 border-red-600 rounded-xl">
        ...
        <p className="text-justify leading-relaxed space-y-4">
          ...
          sendo essencial para garantir assistência médica de qualidade à população de Belford Roxo
          e municípios vizinhos. Sua atuação sempre se pautou pelo compromisso com a vida, respeito
          e excelência na prestação de serviços essenciais de saúde.
          <br />
          <br />
          ...
          <br />
          <br />
          Mesmo diante da inadimplência do município, a instituição manteve os atendimentos de forma
          ininterrupta, arcando com custos operacionais para evitar prejuízos irreparáveis à
          ...
          <br />
          <br />
          A alegação da Prefeitura de que a suspensão dos repasses decorre da suposta irregularidade
          na CND não possui respaldo legal. A legislação vigente é clara: a retenção de pagamentos
          por ausência de CND não está prevista no artigo 87 da Lei nº 8.666/93, tornando essa
          prática ilegal e configurando enriquecimento ilícito por parte do Poder Público.
          <br />
          <br />
          Portanto, a alegação de irregularidades generalizadas por parte do hospital não condiz com
          a realidade e se sustenta em justificativas infundadas.
          <br />
          <br />
          ...
          hospital, enquanto permaneceu inadimplente, transferindo à instituição um ônus indevido e
          inviabilizando financeiramente a continuidade dos atendimentos.
          <br />
          <br />
          ...
          obrigações financeiras, tenta justificar ilegalmente a retenção de pagamentos por meio de
          alegações infundadas sobre certidões obrigatórias.
          <br />
          <br />
          O hospital reafirma seu compromisso com a população e seguirá tomando todas as medidas
          legais cabíveis para reverter essa situação, garantindo que os atendimentos sejam mantidos
          sem imposições arbitrárias e com a responsabilidade que a saúde pública exige. Além disso,
          destaca sua preocupação com os 148 trabalhadores e suas famílias, bem como a manutenção
          das obrigações trabalhistas com caráter alimentar.
          <br />
          <br />
          Atenciosamente,
          <br />
