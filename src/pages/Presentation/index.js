    ...
    <>
      <section className="bg-white dark:bg-gray-900 min-h-screen flex items-center justify-center">
        <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
          <img src="/public/apple-icon.png" alt="Logo" className="mx-auto mb-6 w-24 h-24" />
          <h1 className="mb-6 text-4xl font-bold tracking-tight leading-none text-gray-900 md:text-5xl xl:text-6xl dark:text-white">
            Nota Oficial
          </h1>
          <p className="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400 text-justify whitespace-pre-line">
